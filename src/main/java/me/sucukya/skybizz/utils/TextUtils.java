...
public class TextUtils {
    /* Yes this is the SkyblockAddons TextUtils class but modified
    * https://github.com/BiscuitDevelopment/SkyblockAddons/blob/d5f53c0a4e486c5094aefaee683aacd79c1db756/src/main/java/codes/biscuit/skyblockaddons/utils/TextUtils.java
    * */
    public static final NumberFormat NUMBER_FORMAT = NumberFormat.getInstance(Locale.US);

    private static final Pattern STRIP_COLOR_PATTERN = Pattern.compile("(?i)§[0-9A-FK-ORZ]");

    private static final Pattern LETTERS_AND_SPACE = Pattern.compile("^[ A-Za-z]+$");
    private static final Pattern STRIP_ICONS_PATTERN = Pattern.compile("[♲Ⓑ⚒ቾ]+");

    private static final Pattern STRIP_ACTIONBAR_ICONS_PATTERN = Pattern.compile("[❤❈✎🞠]+");
    ...
    public static String stripActionBarIcons(String text) {return STRIP_ACTIONBAR_ICONS_PATTERN.matcher(text).replaceAll("");
    }
    ...
    public static boolean onlyCharacters(String text) {
        return LETTERS_AND_SPACE.matcher(text).matches();
    }
